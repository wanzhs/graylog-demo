...
public class MybatisDBChargingConfig {
    ...
    public DataSource dataSource(DBChargingConfig config) throws SQLException {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("dataSource") DataSource dataSource)
        ...
        bean.setTypeEnumsPackage("com.example.demo.entity");
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:/DBChargingMapper/**Mapper.xml"));
        //***导入Mybatis配置***
